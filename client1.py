...
def retrain_and_evaluate(client_id, datasets, iterations):
    ...
    models = [YOLO('last_client1.pt') for _ in range(modelcount)]  # 載入上一次訓練的結果
    accuracies = []
...
def main():
    ...
    fedclient = FedClient()
    datasets = [
        f"/Users/kuangsin/FedAvg/clients/client1/horizon/data.yaml",
        f"/Users/kuangsin/FedAvg/clients/client1/top/data.yaml",
    ]
